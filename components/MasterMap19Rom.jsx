...
function MasterMap19Rom() {
  ...
  return (
    <div className="h-[100%] w-[100%]">
      <div className="flex items-center  justify-between bg-indigo-400 p-4">
        ...
        <div className="">
          ...
          <div className="flex items-center gap-x-2">
            ...
            {Master.filter((i) => i["2019_Q1_txn_to_Romania"] >= limit).length}
          </div>
          ...
          <div className="flex items-center gap-x-2">
            ...
            {
              Master.filter(
                (i) => i["2019_Q1_txn_to_Romania"] >= limit && i.Color === "gold"
              ).length
            }
          </div>
          <div className="flex items-center gap-x-2">
            ...
            {
              Master.filter(
                (i) => i["2019_Q1_txn_to_Romania"] >= limit && i.Color === "blue"
              ).length
            }
          </div>
          <div className="flex items-center gap-x-2">
            ...
            {
              Master.filter(
                (i) => i["2019_Q1_txn_to_Romania"] >= limit && i.Color === "red"
              ).length
            }
          </div>
          <div className="flex items-center gap-x-2">
            ...
            <span className="font-bold">Ucambio:</span>{" "}
            {
              Master.filter(
                (i) =>
                  i["2019_Q1_txn_to_Romania"] >= limit &&
                  i.Color === "lightgreen"
              ).length
            }
          </div>
      ...
      >
        {Master.filter(
          (pblocs) => pblocs["2019_Q1_txn_to_Romania"] >= limit
        ).map((pblocs) => (
