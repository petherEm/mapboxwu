...
function MasterMap19Afg() {
  ...
  return (
    <div className="h-[100%] w-[100%]">
      <div className="flex items-center  justify-between bg-indigo-400 p-4">
        ...
        <div className="">
          ...
          <div>
            ...
            {Master.filter((i) => i["2019_Q1_txn_to_Afghanistan"] > limit).length}
          </div>
          ...
          <div>
            <span className="font-bold">PB:</span>{" "}
            {
              Master.filter(
                (i) =>
                  i["2019_Q1_txn_to_Afghanistan"] > limit && i.Color === "gold"
              ).length
            }
          </div>
          <div>
            ...
            {
              Master.filter(
                (i) => i["2019_Q1_txn_to_Afghanistan"] > limit && i.Color === "blue"
              ).length
            }
          </div>
          <div>
            ...
            {
              Master.filter(
                (i) => i["2019_Q1_txn_to_Afghanistan"] > limit && i.Color === "red"
              ).length
            }
          </div>
        </div>
      ...
      >
        {Master.filter(
          (pblocs) => pblocs["2019_Q1_txn_to_Afghanistan"] >= limit
        ).map((pblocs) => (
