  ...
  return (
    <div className="p-2 h-[100%] w-[100%]">
      <div className="flex items-center  justify-between bg-indigo-400 p-4">
        <div className="">
          <h1 className="text-md font-bold">2019 Transactions per quarter</h1>
          <button
        ...
        <div className="">
          ...
          <div className="flex items-center gap-x-2">
            ...
            {Master.filter((i) => i["2019_Q1_txn_to_Turkey"] >= limit).length}
          </div>
          ...
          <div className="flex items-center gap-x-2">
            ...
            <span className="font-bold">PB:</span>{" "}
            {
              Master.filter(
                (i) =>
                  i["2019_Q1_txn_to_Turkey"] >= limit && i.Color === "gold"
              ).length
            }
          </div>
          <div className="flex items-center gap-x-2">
            ...
            {
              Master.filter(
                (i) => i["2019_Q1_txn_to_Turkey"] >= limit && i.Color === "blue"
              ).length
            }
          </div>
          <div className="flex items-center gap-x-2">
            ...
            {
              Master.filter(
                (i) => i["2019_Q1_txn_to_Turkey"] >= limit && i.Color === "red"
              ).length
            }
          </div>
          <div className="flex items-center gap-x-2">
            ...
            {
              Master.filter(
                (i) => i["2019_Q1_txn_to_Turkey"] >= limit && i.Color === "lightgreen"
              ).length
            }
          </div>
        </div>
      ...
      >
        {Master.filter(
          (pblocs) => pblocs["2019_Q1_txn_to_Turkey"] >= limit
        ).map((pblocs) => (
