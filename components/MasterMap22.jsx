...
function MasterMap22() {
  ...
  return (
    <div className="p-2 h-[100%] w-[100%]">
      <div className="flex items-center  justify-between bg-indigo-400 p-4">
        ...
        <div className="">
          ...
          <div className="flex items-center gap-x-2">
            ...
            {Master.filter((i) => i["2022_Q1_txn_to_Turkey"] >= limit).length}
          </div>
          ...
          <div className="flex items-center gap-x-2">
            ...
            {
              Master.filter(
                (i) => i["2022_Q1_txn_to_Turkey"] >= limit && i.Color === "gold"
              ).length
            }
          </div>
          <div className="flex items-center gap-x-2">
            ...
            {
              Master.filter(
                (i) => i["2022_Q1_txn_to_Turkey"] >= limit && i.Color === "blue"
              ).length
            }
          </div>
          <div className="flex items-center gap-x-2">
            ...
            {
              Master.filter(
                (i) => i["2022_Q1_txn_to_Turkey"] >= limit && i.Color === "red"
              ).length
            }
          </div>
          <div className="flex items-center gap-x-2">
      ...
      >
        {Master.filter(
          (pblocs) => pblocs["2022_Q1_txn_to_Turkey"] >= limit
        ).map((pblocs) => (
